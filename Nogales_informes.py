...
for y in year:
    for b in bimester:
        driver.find_element_by_name("Drop_Ano").send_keys(y) 
        driver.find_element_by_name("Drop_bim").send_keys(b) 
        driver.find_element_by_id("RadioButtonList2_1").click() # inform
        driver.find_element_by_id("RadioButtonList1_1").click() # student
